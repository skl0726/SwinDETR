""" Eval Model - mAP, FPS (Swin Transformer (swin_t) Based DETR) """
...
if __name__ == '__main__':
    parser = ArgumentParser('eval_swin_t.py', parents=[base_parser()])
    ...
    parser.add_argument('--task_name', default='coco_swin_t_eval', type=str)
