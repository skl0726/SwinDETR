#!/bin/sh
#SBATCH -J swindetr_hdistill50       # job name
#SBATCH -o swindetr_hdistill50.out   # name of stdout output file (%j expands to %jobId)
#SBATCH -e swindetr_hdistill50.err   # define file name of standard error
...
python3 -m train_ddp --num_distill_query 50 --task_name 'swindetr_hdistill50'
