#!/bin/sh
#SBATCH -J swindetr_hdistill100       # job name
#SBATCH -o swindetr_hdistill100.out   # name of stdout output file (%j expands to %jobId)
#SBATCH -e swindetr_hdistill100.err   # define file name of standard error
...
python3 -m train_ddp --num_distill_query 100 --task_name 'swindetr_hdistill100'
