#!/bin/sh
#SBATCH -J train_densenet       # job name
#SBATCH -o train_densenet.out   # name of stdout output file (%j expands to %jobId)
#SBATCH -e train_densenet.err   # define file name of standard error
...
python3 $HOME/temp/SwinDETR/train_densenet.py
