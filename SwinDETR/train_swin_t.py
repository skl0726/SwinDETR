""" Train Model (Swin Transformer (swin_t) Based DETR) """
...
if __name__ == '__main__':
    parser = ArgumentParser('train_swin_t.py', parents=[base_parser()])

    parser.add_argument('--swin_transformer', default='swin_t', type=str) # swin transformer (swin_t) based model training
    ...
    parser.add_argument('--task_name', default='coco_swin_t', type=str) # swin transformer (swin_t) based model training
